...
/**
 * A sequence of primitive int-valued elements supporting sequential operations. This is the {@code
 * int} primitive specialization of {@link Stream}.
 */
public final class IntStream implements Closeable {

    /**
     * Single instance for empty stream. It is safe for multi-thread environment because it has no
     * content.
     */
    ...
    /**
     * Creates an {@code IntStream} of code point values from the given sequence. Any surrogate
     * pairs encountered in the sequence are combined as if by {@linkplain Character#toCodePoint
     * Character.toCodePoint} and the result is passed to the stream. Any other code units,
     * including ordinary BMP characters, unpaired surrogates, and undefined code units, are
    ...
    /**
     * Returns an infinite sequential unordered stream where each element is generated by the
     * provided {@code IntSupplier}. This is suitable for generating constant streams, streams of
     * random elements, etc.
     *
    ...
    /**
     * Returns an infinite sequential ordered {@code IntStream} produced by iterative application of
     * a function {@code f} to an initial element {@code seed}, producing a {@code Stream}
     * consisting of {@code seed}, {@code f(seed)}, {@code f(f(seed))}, etc.
     *
     * <p>The first element (position {@code 0}) in the {@code IntStream} will be the provided
    ...
    /**
     * Creates an {@code IntStream} by iterative application {@code IntUnaryOperator} function to an
     ...
     * @throws NullPointerException if {@code a} or {@code b} or {@code rest} is null
     * @since 1.2.2
     */
    @NotNull
    public static IntStream concat(
        ...
        final List<Closeable> closeables = new ArrayList<Closeable>(rest.length + 2);
     ...
     *
     * <p>Transforming function can return {@code IntStream} for intermediate operations, or any
     * value for terminal operation.
     *
     * <p>Operator examples:
     *
     * <pre><code>
     ...
     *
     * <p>This is similar to {@code IntStream.concat(stream, this)}
     *
     * <p>Example:
     *
     * <pre>
     ...
     *
     * <p>This is similar to {@code IntStream.concat(this, stream)}
     *
     * <p>Example:
     *
     * <pre>
     ...
     * </pre>
     *
     * @param predicate non-interfering, stateless predicate to apply to each element to determine
    ...
    /**
     * Returns an {@code IntStream} with elements that satisfy the given {@code
     * IndexedIntPredicate}.
     *
     * <p>This is an intermediate operation.
     *
    ...
    public IntStream filterIndexed(int from, int step, @NotNull IndexedIntPredicate predicate) {
        return new IntStream(
                params,
                new IntFilterIndexed(
                        new PrimitiveIndexedIterator.OfInt(from, step, iterator), predicate));
    }

    /**
     * Returns a stream consisting of the elements of this stream that don't match the given
     * predicate.
     *
     * <p>This is an intermediate operation.
     *
    ...
    /**
     * Returns an {@code IntStream} consisting of the results of applying the given function to the
    ...
    /**
     * Returns an {@code IntStream} with elements that obtained by applying the given {@code
     * IntBinaryOperator}.
     *
     * <p>This is an intermediate operation.
     *
    ...
    public IntStream mapIndexed(int from, int step, @NotNull IntBinaryOperator mapper) {
        return new IntStream(
                params,
                new IntMapIndexed(
                        new PrimitiveIndexedIterator.OfInt(from, step, iterator), mapper));
    }

    /**
     * Returns a {@code Stream} consisting of the results of applying the given function to the
     * elements of this stream.
     *
     * <p>This is an intermediate operation.
     *
    ...
    /**
     * Returns a {@code DoubleStream} consisting of the results of applying the given function to
    ...
    public interface IntMapMultiConsumer {
        /**
         * Replaces the given {@code value} with zero or more values by feeding the mapped values to
         * the {@code consumer} consumer.
         *
    ...
    /**
     * Returns {@code IntStream} with sorted elements (as determinated by provided {@code
     * Comparator}).
     *
     * <p>This is a stateful intermediate operation.
     *
     ...
     * provided action on each element as elements are consumed from the resulting stream. Handy
    ...
    /**
     * Returns a {@code IntStream} produced by iterative application of a accumulation function to
     * reduction value and next element of the current stream. Produces a {@code IntStream}
     * consisting of {@code value1}, {@code acc(value1, value2)}, {@code acc(acc(value1, value2),
     * value3)}, etc.
     *
     * <p>This is an intermediate operation.
     *
    ...
    /**
     * Returns a {@code IntStream} produced by iterative application of a accumulation function to
     * an initial element {@code identity} and next element of the current stream. Produces a {@code
     * IntStream} consisting of {@code identity}, {@code acc(identity, value1)}, {@code
     ...
     * first {@code n} elements of the stream. If this stream contains fewer than {@code n} elements
     ...
     *
     * <p>The {@code identity} value must be an identity for the accumulator function. This means
     * that for all {@code x}, {@code accumulator.apply(identity, x)} is equal to {@code x}. The
     * {@code accumulator} function must be an associative function.
     *
     * <p>This is a terminal operation.
     *
     * <p>Example:
     ...
     * function, and returns an {@code OptionalInt} describing the reduced value, if any.
     *
     ...
     * @see Stream#collect(com.annimon.stream.function.Supplier,
     ...
     * optional if this stream is empty.
     *
     * <p>This is a terminal operation.
     *
     ...
     * empty then {@code false} is returned and the predicate is not evaluated.
     *
     ...
     * the predicate on all elements if not necessary for determining the result. If the stream is
     * empty then {@code true} is returned and the predicate is not evaluated.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     * <p>Example:
    ...
    /**
     * Returns an {@link OptionalInt} describing the first element of this stream, or an empty
     * {@code OptionalInt} if the stream is empty.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     * @return an {@code OptionalInt} describing the first element of this stream, or an empty
     *     {@code OptionalInt} if the stream is empty
     */
    @NotNull
    ...
    /**
     * Returns the last element wrapped by {@code OptionalInt} class. If stream is empty, returns
     * {@code OptionalInt.empty()}.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     * @return an {@code OptionalInt} with the last element or {@code OptionalInt.empty()} if the
     *     stream is empty
     * @since 1.1.8
     */
    @NotNull
    ...
    /**
     * Returns the single element wrapped by {@code OptionalInt} class. If stream is empty, returns
     * {@code OptionalInt.empty()}. If stream contains more than one element, throws {@code
     * IllegalStateException}.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     ...
     * </pre>
     *
     * @return an {@code OptionalInt} with single element or {@code OptionalInt.empty()} if stream
     *     is empty
     * @throws IllegalStateException if stream contains more than one element
     * @since 1.1.3
     */
