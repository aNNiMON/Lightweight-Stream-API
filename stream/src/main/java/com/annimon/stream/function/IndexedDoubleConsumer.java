...
public interface IndexedDoubleConsumer {
    ...
    class Util {
        ...
        public static IndexedDoubleConsumer andThen(
                @NotNull final IndexedDoubleConsumer c1, @NotNull final IndexedDoubleConsumer c2) {
        ...
        /**
         * Returns an {@code IndexedDoubleConsumer} that accepts {@code IntConsumer} for index and
         * {@code DoubleConsumer} for value.
         *
         * <pre><code>
         *  if (c1 != null)
         *      c1.accept(index);
        ...
        public static IndexedDoubleConsumer accept(
                @Nullable final IntConsumer c1, @Nullable final DoubleConsumer c2) {
            return new IndexedDoubleConsumer() {
                @Override
                public void accept(int index, double value) {
                    if (c1 != null) {
