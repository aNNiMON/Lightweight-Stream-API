...
public final class DoubleStream implements Closeable {
     ...
     * to an initial element {@code seed}. Produces {@code DoubleStream} consisting of {@code seed},
    ...
    public static DoubleStream concat(
            @NotNull final DoubleStream a, @NotNull final DoubleStream b) {
     ...
     *
     * <p>Transforming function can return {@code DoubleStream} for intermediate operations, or any
     ...
     *
     * <p>This is similar to {@code DoubleStream.concat(stream, this)}
     *
     * <p>Example:
     *
     * <pre>
     ...
     *
     * <p>This is similar to {@code DoubleStream.concat(this, stream)}
     *
     * <p>Example:
     *
     * <pre>
    ...
    /**
     * Returns a {@code DoubleStream} with elements that satisfy the given {@code
     ...
     */
    @NotNull
    public DoubleStream filterIndexed(
            int from, int step, @NotNull IndexedDoublePredicate predicate) {
        return new DoubleStream(
                params,
                new DoubleFilterIndexed(
                        new PrimitiveIndexedIterator.OfDouble(from, step, iterator), predicate));
    }
    ...
    /**
     * Returns an {@code DoubleStream} consisting of the results of applying the given function to
    ...
    /**
     * Returns a {@code DoubleStream} with elements that obtained by applying the given {@code
    ...
    public DoubleStream mapIndexed(int from, int step, @NotNull IndexedDoubleUnaryOperator mapper) {
        return new DoubleStream(
                params,
                new DoubleMapIndexed(
                        new PrimitiveIndexedIterator.OfDouble(from, step, iterator), mapper));
    }
    ...
    /**
     * Returns an {@code LongStream} consisting of the results of applying the given function to the
     * elements of this stream.
     *
     * <p>This is an intermediate operation.
     *
    ...
    /**
     * Returns a stream consisting of the elements of this stream in sorted order as determinated by
     ...
     * to reduction value and next element of the current stream. Produces a {@code DoubleStream}
    ...
    /**
     * Returns a {@code DoubleStream} produced by iterative application of a accumulation function
     * to an initial element {@code identity} and next element of the current stream. Produces a
     * {@code DoubleStream} consisting of {@code identity}, {@code acc(identity, value1)}, {@code
    ...
    public DoubleStream scan(
            final double identity, @NotNull final DoubleBinaryOperator accumulator) {
        Objects.requireNonNull(accumulator);
    ...
    /**
     * Skips first {@code n} elements and returns {@code DoubleStream} with remaining elements. If
     * this stream contains fewer than {@code n} elements, then an empty stream will be returned.
     *
     * <p>This is a stateful intermediate operation.
     *
     * <p>Example:
     ...
     * function, and returns an {@code OptionalDouble} describing the reduced value, if any.
     *
    ...
    /**
     * Returns an {@code OptionalDouble} describing the minimum element of this stream, or an empty
    ...
    /**
     * Returns an {@code OptionalDouble} describing the maximum element of this stream, or an empty
     * optional if this stream is empty.
     *
     * <p>This is a terminal operation.
     *
    ...
    /**
     * Tests whether all elements match the given predicate. May not evaluate the predicate on all
     * elements if not necessary for determining the result. If the stream is empty then {@code
    ...
    public boolean anyMatch(@NotNull DoublePredicate predicate) {
        while (iterator.hasNext()) {
            if (predicate.test(iterator.nextDouble())) return true;
        }
        return false;
    }
    ...
    public boolean allMatch(@NotNull DoublePredicate predicate) {
        while (iterator.hasNext()) {
            if (!predicate.test(iterator.nextDouble())) return false;
        }
        return true;
    }

    /**
     * Tests whether no elements match the given predicate. May not evaluate the predicate on all
     * elements if not necessary for determining the result. If the stream is empty then {@code
     * true} is returned and the predicate is not evaluated.
     *
     * <p>This is a short-circuiting terminal operation.
    ...
    /**
     * Returns the first element wrapped by {@code OptionalDouble} class. If stream is empty,
     * returns {@code OptionalDouble.empty()}.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     * @return an {@code OptionalDouble} with first element or {@code OptionalDouble.empty()} if
     *     stream is empty
     */
    @NotNull
    ...
    /**
     * Returns the last element wrapped by {@code OptionalDouble} class. If stream is empty, returns
     * {@code OptionalDouble.empty()}.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     * @return an {@code OptionalDouble} with the last element or {@code OptionalDouble.empty()} if
     *     the stream is empty
     * @since 1.1.8
     */
    @NotNull
    ...
    /**
     * Returns the single element wrapped by {@code OptionalDouble} class. If stream is empty,
     * returns {@code OptionalDouble.empty()}. If stream contains more than one element, throws
     ...
     * </pre>
     *
     * @return an {@code OptionalDouble} with single element or {@code OptionalDouble.empty()} if
     *     stream is empty
     * @throws IllegalStateException if stream contains more than one element
     */
    @NotNull
