...
public final class OptionalBoolean {
    ...
    /**
     * Returns an {@code OptionalBoolean} with the specified value, or empty {@code OptionalBoolean}
     * if value is null.
     *
     ...
     * @return this {@code OptionalBoolean} if the value is present and matches predicate, otherwise
    ...
    /**
     * Returns current {@code OptionalBoolean} if value is present, otherwise returns an {@code
     * OptionalBoolean} produced by supplier function.
     *
     * @param supplier supplier function that produces an {@code OptionalBoolean} to be returned
     * @return this {@code OptionalBoolean} if value is present, otherwise an {@code
     *     OptionalBoolean} produced by supplier function
     ...
     */
    public <X extends Throwable> boolean orElseThrow(@NotNull Supplier<X> exceptionSupplier)
            throws X {
        if (isPresent) {
            return value;
        } else {
