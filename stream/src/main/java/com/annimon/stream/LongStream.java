...
public final class LongStream implements Closeable {
    ...
    /**
     * Creates a {@code LongStream} by iterative application {@code LongUnaryOperator} function to
     * an initial element {@code seed}. Produces {@code LongStream} consisting of {@code seed},
     * {@code f(seed)}, {@code f(f(seed))}, etc.
     *
     * <p>The first element (position {@code 0}) in the {@code LongStream} will be the provided
    ...
    /**
     * Creates an {@code LongStream} by iterative application {@code LongUnaryOperator} function to
     * an initial element {@code seed}, conditioned on satisfying the supplied predicate.
     *
     * <p>Example:
     *
     * <pre>
     ...
     *
     * <p>Transforming function can return {@code LongStream} for intermediate operations, or any
     ...
     *
     * <p>This is similar to {@code LongStream.concat(stream, this)}
     *
     * <p>Example:
     *
     * <pre>
     ...
     *
     * <p>This is similar to {@code LongStream.concat(this, stream)}
     *
     * <p>Example:
     *
     * <pre>
    ...
    /**
     * Returns a {@code LongStream} with elements that satisfy the given {@code
    ...
    public LongStream filterIndexed(int from, int step, @NotNull IndexedLongPredicate predicate) {
        return new LongStream(
                params,
                new LongFilterIndexed(
                        new PrimitiveIndexedIterator.OfLong(from, step, iterator), predicate));
    }
    ...
    /**
     * Returns a {@code LongStream} with elements that obtained by applying the given {@code
    ...
    public LongStream mapIndexed(int from, int step, @NotNull IndexedLongUnaryOperator mapper) {
        return new LongStream(
                params,
                new LongMapIndexed(
                        new PrimitiveIndexedIterator.OfLong(from, step, iterator), mapper));
    }
    ...
    /**
     * Returns a {@code LongStream} produced by iterative application of a accumulation function to
     * reduction value and next element of the current stream. Produces a {@code LongStream}
     ...
     * LongStream} consisting of {@code identity}, {@code acc(identity, value1)}, {@code
    ...
    /**
     * Skips first {@code n} elements and returns {@code LongStream} with remaining elements. If
     ...
     * function, and returns an {@code OptionalLong} describing the reduced value, if any.
     *
    ...
    /**
     * Returns an {@code OptionalLong} describing the minimum element of this stream, or an empty
    ...
    /**
     * Returns an {@code OptionalLong} describing the maximum element of this stream, or an empty
     * optional if this stream is empty.
     *
     * <p>This is a terminal operation.
     *
    ...
    /**
     * Returns the first element wrapped by {@code OptionalLong} class. If stream is empty, returns
     * {@code OptionalLong.empty()}.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     * @return an {@code OptionalLong} with first element or {@code OptionalLong.empty()} if stream
     *     is empty
     */
    @NotNull
    ...
    /**
     * Returns the last element wrapped by {@code OptionalLong} class. If stream is empty, returns
     * {@code OptionalLong.empty()}.
     *
     * <p>This is a short-circuiting terminal operation.
     *
     * @return an {@code OptionalLong} with the last element or {@code OptionalLong.empty()} if the
     *     stream is empty
     * @since 1.1.8
     */
    @NotNull
    ...
    /**
     * Returns the single element wrapped by {@code OptionalLong} class. If stream is empty, returns
     * {@code OptionalLong.empty()}. If stream contains more than one element, throws {@code
     * IllegalStateException}.
     *
     * <p>This is a short-circuiting terminal operation.
     *
