...
public class ExceptionalTest {
    ...
    @Test
    public void testGet() {
        int value = Exceptional.of(tenSupplier).get();
        assertEquals(10, value);
    }

    @Test
    public void testIsPresent() {
        assertTrue(Exceptional.of(tenSupplier).isPresent());

        assertFalse(Exceptional.of(ioExceptionSupplier).isPresent());
    }

    @Test
    public void testGetOrElse() {
        int value = Exceptional.of(ioExceptionSupplier).getOrElse(20);
        assertEquals(20, value);

        value = Exceptional.of(tenSupplier).getOrElse(20);
        assertEquals(10, value);
        ...
        value = Exceptional.of(ioExceptionSupplier).getOrElse(supplier);
        assertEquals(3228, value);

        value = Exceptional.of(tenSupplier).getOrElse(supplier);
        assertEquals(10, value);
    }

    @Test
    public void testGetOptional() {
        Optional<Integer> value = Exceptional.of(ioExceptionSupplier).getOptional();
        assertFalse(value.isPresent());
    }

    @Test
    public void testGetException() {
        Throwable throwable = Exceptional.of(ioExceptionSupplier).getException();
    ...
    public void testGetOrThrowWithoutException() throws Throwable {
        int value = Exceptional.of(tenSupplier).getOrThrow();
        assertEquals(10, value);
    }

    @Test(expected = IOException.class)
    public void testGetOrThrowWithException() throws Throwable {
        Exceptional.of(ioExceptionSupplier).getOrThrow();
    }

    @Test
    public void testGetOrThrowRuntimeExceptionWithoutException() {
        int value = Exceptional.of(tenSupplier).getOrThrowRuntimeException();
        assertEquals(10, value);
    }

    @Test(expected = RuntimeException.class)
    public void testGetOrThrowRuntimeExceptionWithException() {
        Exceptional.of(ioExceptionSupplier).getOrThrowRuntimeException();
    }

    @Test
    public void testGetOrThrowNewExceptionWithoutException() {
        int value = Exceptional.of(tenSupplier).getOrThrow(new ArithmeticException());
        assertEquals(10, value);
    }

    @Test(expected = ArithmeticException.class)
    public void testGetOrThrowNewExceptionWithException() {
        Exceptional.of(ioExceptionSupplier).getOrThrow(new ArithmeticException());
    }
    ...
    public void testOr() {
        int value =
                Exceptional.of(tenSupplier)
                        .or(
                                new Supplier<Exceptional<Integer>>() {
                                    @Override
    ...
    public void testCustomIntermediate() {
        UnaryOperator<Exceptional<Integer>> incrementer =
                new UnaryOperator<Exceptional<Integer>>() {
                    @Override
                    public Exceptional<Integer> apply(Exceptional<Integer> exceptional) {
                        return exceptional.map(
                                new ThrowableFunction<Integer, Integer, Throwable>() {
                                    @Override
        ...
        int value;
        value = Exceptional.of(ioExceptionSupplier).custom(incrementer).getOrElse(0);
        assertEquals(0, value);

        value = Exceptional.of(tenSupplier).custom(incrementer).getOrElse(0);
        assertEquals(11, value);
    }

    @Test
    public void testCustomTerminal() {
        Function<Exceptional<Integer>, Integer> incrementer =
                new Function<Exceptional<Integer>, Integer>() {
                    @Override
        ...
        int value;
        value = Exceptional.of(ioExceptionSupplier).custom(incrementer);
        assertEquals(0, value);

        value = Exceptional.of(tenSupplier).custom(incrementer);
        assertEquals(11, value);
    }
    ...
    public void testMapWithoutException() {
        String value =
                Exceptional.of(tenSupplier)
                        .map(
                                new ThrowableFunction<Integer, String, Throwable>() {
                                    @Override
    ...
    public void testMapOnNullFunction() throws Throwable {
        Exceptional.of(tenSupplier).map(null).getOrThrow();
    }
    ...
    public void testIfExceptionIs() {
        ...
        Exceptional.of(
                ...
                .ifExceptionIs(
                        ...
                        new Consumer<InterruptedException>() {
                            @Override
    ...
    public void testRecover() {
        int value =
                Exceptional.of(ioExceptionSupplier)
                        .recover(
                                new ThrowableFunction<Throwable, Integer, Throwable>() {
                                    @Override
                ...
                Exceptional.of(ioExceptionSupplier)
                        ...
                        .recover(
                                new ThrowableFunction<Throwable, Integer, Throwable>() {
                                    ...
                                    public Integer apply(Throwable throwable) {
                                        assertThat(
                                                throwable, instanceOf(FileNotFoundException.class));
                                        return 10;
                                    }
                                })
                        .get();
    ...
    public void testRecoverWith() {
        int value =
                Exceptional.of(ioExceptionSupplier)
                        .recoverWith(
                                new Function<Throwable, Exceptional<Integer>>() {
                                    @Override
    ...
    public void testEqualsWithDifferentNumberTypes() {
        final Exceptional<Integer> ten1 = Exceptional.of(tenSupplier);
        final Exceptional<Byte> tenByte =
                Exceptional.of(
                        new ThrowableSupplier<Byte, Throwable>() {
                            @Override
                            public Byte get() {
                                return (byte) 10;
                            }
    ...
    public void testEqualsWithDifferentExceptions() {
        final Exceptional<Integer> ten1 = Exceptional.of(tenSupplier);
        final Exceptional<Integer> ten2 =
                Exceptional.of(
                        new ThrowableSupplier<Integer, Throwable>() {
                            @Override
                            public Integer get() throws Throwable {
    ...
    public void testToStringWithException() {
        assertEquals(
                "Exceptional throwable java.io.IOException",
                Exceptional.of(ioExceptionSupplier).toString());
    }
