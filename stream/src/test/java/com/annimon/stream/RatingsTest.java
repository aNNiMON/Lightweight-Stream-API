...
public class RatingsTest {
    ...
    public void testRatings() {
        String ratings =
                Stream.of(fileContents.keySet()) // list files
                        // read content of files
                        .flatMap(
                                Function.Util.safe(
                                        new ThrowableFunction<String, Stream<String>, Throwable>() {
                                            @Override
                        ...
                        .map(
                                new Function<String[], IntPair<String>>() {
                                    @Override
                        ...
                        // Group by name
                        .groupBy(
                                new Function<IntPair<String>, String>() {
                                    @Override
                        ...
                        .map(
                                new Function<
                                        Map.Entry<String, List<IntPair<String>>>,
                                        IntPair<String>>() {
                                    @Override
                                    public IntPair<String> apply(
                                            Map.Entry<String, List<IntPair<String>>> entry) {
                        ...
                        .sortBy(
                                new Function<IntPair<String>, Integer>() {
                                    @Override
                                ...
                                new Function<IntPair<String>, String>() {
                                    ...
                                    public String apply(IntPair<String> value) {
                                        return String.format(
                                                "%12s: %d", value.getSecond(), value.getFirst());
                                    }
                                })
                        // lines to string
