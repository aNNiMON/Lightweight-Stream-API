...
public final class ScanTest {
    ...
    public void testScan() {
        LongStream.of(1, 2, 3)
                ...
                .custom(assertElements(arrayContaining(1L, 3L, 6L)));
    }
    ...
    public void testScanNonAssociative() {
        LongStream.of(1800L, 2, 3, 5)
                ...
                .custom(
                        assertElements(
                                arrayContaining(
                                        1800L, 1800L / 2, 1800L / 2 / 3, 1800L / 2 / 3 / 5)));
    }
    ...
    public void testScanWithIdentity() {
        LongStream.of(1, 2, 3)
                ...
                .custom(assertElements(arrayContaining(0L, 1L, 3L, 6L)));
    }
    ...
    public void testScanWithIdentityOnEmptyStream() {
        LongStream.empty()
                ...
                .custom(assertElements(arrayContaining(9L)));
    }
}
