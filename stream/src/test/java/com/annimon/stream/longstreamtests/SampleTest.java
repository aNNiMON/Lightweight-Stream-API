...
public final class SampleTest {
    ...
    public void testSample() {
        LongStream.of(12, 32, 9, 22, 41, 42)
                .sample(2)
                .custom(assertElements(arrayContaining(12L, 9L, 41L)));

        LongStream.of(12, 32, 9, 22, 41, 42)
                .skip(1)
                .sample(2)
                .custom(assertElements(arrayContaining(32L, 22L, 42L)));
    }
    ...
    public void testSampleWithStep1() {
        LongStream.of(12, 32, 9, 22, 41, 42)
                .sample(1)
                .custom(assertElements(arrayContaining(12L, 32L, 9L, 22L, 41L, 42L)));
    }
