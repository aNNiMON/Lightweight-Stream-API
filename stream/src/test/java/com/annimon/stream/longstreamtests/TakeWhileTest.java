...
public final class TakeWhileTest {
    ...
    public void testTakeWhile() {
        LongStream.of(12, 32, 22, 9, 30, 41, 42)
                ...
                .custom(assertElements(arrayContaining(12L, 32L, 22L)));
    }
    ...
    public void testTakeWhileAllMatch() {
        LongStream.of(10, 20, 30)
                .takeWhile(Functions.remainderLong(2))
                .custom(assertElements(arrayContaining(10L, 20L, 30L)));
    }

    @Test
    public void testTakeWhileIterator() {
        PrimitiveIterator.OfLong it =
                LongStream.of(2, 4, 5, 6).takeWhile(Functions.remainderLong(2)).iterator();
    ...
    public void testTakeWhileIterator2() {
        PrimitiveIterator.OfLong it =
                LongStream.of(1).takeWhile(Functions.remainderLong(2)).iterator();
        assertThat(it.hasNext(), is(false));
        assertThat(it.hasNext(), is(false));
    }
    ...
    public void testTakeWhileIterator3() {
        final PrimitiveIterator.OfLong it =
                LongStream.of(2).takeWhile(Functions.remainderLong(2)).iterator();
