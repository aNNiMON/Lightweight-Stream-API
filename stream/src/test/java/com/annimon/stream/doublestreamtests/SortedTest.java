...
public final class SortedTest {
    ...
    public void testSorted() {
        DoubleStream.of(1.2, 3.234, 0.09, 2.2)
                .sorted()
                .custom(assertElements(arrayContaining(0.09, 1.2, 2.2, 3.234)));
    }

    @Test
    public void testSortedOnEmptyStream() {
        assertThat(DoubleStream.empty().sorted(), isEmpty());
    }
    ...
    public void testSortedWithComparator() {
        DoubleStream.of(1.2, 3.234, 0.09, 2.2)
                ...
                .custom(assertElements(arrayContaining(3.234, 2.2, 1.2, 0.09)));
    }
}
