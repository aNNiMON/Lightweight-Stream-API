...
public final class TakeWhileTest {
    ...
    public void testTakeWhileIterator() {
        PrimitiveIterator.OfDouble it = DoubleStream.of(5, 8.2, 1.19, 120)
                .takeWhile(Functions.greaterThan(Math.PI))
                .iterator();
    ...
    public void testTakeWhileIterator2() {
        PrimitiveIterator.OfDouble it = DoubleStream.of(1)
                .takeWhile(Functions.greaterThan(2))
                .iterator();
        assertThat(it.hasNext(), is(false));
        assertThat(it.hasNext(), is(false));
    }
    ...
    public void testTakeWhileIterator3() {
        final PrimitiveIterator.OfDouble it = DoubleStream.of(5)
                .takeWhile(Functions.greaterThan(2))
                .iterator();
    ...
    public void testTakeWhileAndMapIssue193() {
        boolean match = DoubleStream.of(42, 44, 46, 0, 48)
