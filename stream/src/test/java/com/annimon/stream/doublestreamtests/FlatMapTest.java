...
public final class FlatMapTest {
    ...
    public void testFlatMap() {
        DoubleFunction<DoubleStream> twicer =
                new DoubleFunction<DoubleStream>() {
                    @Override
        ...
        DoubleStream.of(0.012, -3.039, 100d)
                .flatMap(twicer)
                .custom(assertElements(arrayContaining(0.012, 0.012, -3.039, -3.039, 100d, 100d)));
        ...
        DoubleStream.of(0.012, -3.039, 100d)
                ...
                .custom(assertElements(arrayContaining(-3.039)));
        ...
        DoubleStream.of(0.012, -3.039, 100d)
                ...
                .custom(assertElements(arrayContaining(0.012, 100d)));
    }
