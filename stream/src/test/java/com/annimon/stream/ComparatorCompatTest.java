...
public class ComparatorCompatTest {
    ...
    public void testNaturalOrder() {
        ...
        IntStream stream =
                IntStream.of(1, 2, 3, 5, 8, 13).sorted(ComparatorCompat.<Integer>naturalOrder());
    ...
    public void testReverseOrder() {
        ...
        IntStream stream =
                IntStream.of(1, 2, 3, 5, 8, 13).sorted(ComparatorCompat.<Integer>reverseOrder());
        assertThat(stream.toArray(), is(expected));
    }
    ...
    public void testReversedComparator() {
        ...
        IntStream stream =
                IntStream.of(-8, -2, 1, 4, 16)
                        .sorted(ComparatorCompat.reversed(Functions.descendingAbsoluteOrder()));
        assertThat(stream.toArray(), is(expected));
    }
        ...
        Stream.of("abc", "ab", "abcd", "a")
                .sorted(
                        ComparatorCompat.comparing(
                                ...
                                ComparatorCompat.<Integer>reverseOrder()))
                .custom(assertElements(contains("abcd", "abc", "ab", "a")));
    }
    ...
    public void testComparingComparable() {
        Stream.of("abc", "ab", "abcd", "a")
                ...
                .custom(assertElements(contains("a", "ab", "abc", "abcd")));
    }
    ...
    public void testNullsFirst() {
        Stream.of("abc", "ab", null, "abcd", null, "a")
                ...
                .custom(assertElements(contains(null, null, "abc", "ab", "abcd", "a")));
    }
    ...
    public void testNullsFirstComparator() {
        Stream.of("abc", "ab", null, "abcd", null, "a")
                ...
                .custom(assertElements(contains(null, null, "a", "ab", "abc", "abcd")));
    }
    ...
    public void testNullsLast() {
        Stream.of("abc", "ab", null, "abcd", null, "a")
                ...
                .custom(assertElements(contains("abc", "ab", "abcd", "a", null, null)));
    }
    ...
    public void testNullsLastComparator() {
        Stream.of("abc", "ab", null, "abcd", null, "a")
                ...
                .custom(assertElements(contains("a", "ab", "abc", "abcd", null, null)));
    }
    ...
    public void testChain_CourseReversed() {
        ...
        List<Student> input =
                Arrays.asList(Students.MARIA_CS_1, Students.STEVE_CS_4, Students.VICTORIA_CS_3);
        Stream.of(input)
                .sorted(comparator)
                .custom(
                        assertElements(
    ...
    public void testChain_CourseThenName() {
        Comparator<Student> comparator =
                ComparatorCompat.comparing(Students.course).thenComparing(Students.studentName);
    ...
    public void testChain_SpecialityThenCourseThenName() {
        Comparator<Student> comparator =
                ComparatorCompat.comparing(Students.speciality)
                        .thenComparingInt(
    ...
    public void testChain_NameReversedThenCourseThenSpeciality() {
        Comparator<Student> comparator =
                ComparatorCompat.comparing(Students.studentName)
                        .reversed()
    ...
    public void testChain_NameReversedThenCourseThenSpeciality_Deprecation() {
        Comparator<Student> comparator =
                ComparatorCompat.chain(ComparatorCompat.comparing(Students.studentName))
                        .reversed()
                        .thenComparing(Students.course)
                        .thenComparing(Students.speciality)
                        .comparator();
