...
public final class ScanTest {
    ...
    public void testScan() {
        IntStream.of(1, 2, 3)
                ...
                .custom(assertElements(arrayContaining(1, 3, 6)));
    }
    ...
    public void testScanNonAssociative() {
        IntStream.of(1800, 2, 3, 5)
                ...
                .custom(
                        assertElements(
                                arrayContaining(1800, 1800 / 2, 1800 / 2 / 3, 1800 / 2 / 3 / 5)));
    }
    ...
    public void testScanWithIdentity() {
        IntStream.of(1, 2, 3)
                ...
                .custom(assertElements(arrayContaining(0, 1, 3, 6)));
    }
    ...
    public void testScanWithIdentityOnEmptyStream() {
        IntStream.empty()
                ...
                .custom(assertElements(arrayContaining(9)));
    }
}
