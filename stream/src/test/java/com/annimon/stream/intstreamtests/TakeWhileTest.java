...
public final class TakeWhileTest {
    ...
    public void testTakeWhile() {
        IntStream.of(2, 4, 6, 7, 8, 10, 11)
                ...
                .custom(assertElements(arrayContaining(2, 4, 6)));
    }
    ...
    public void testTakeWhileAllMatch() {
        IntStream.of(2, 4, 6, 7, 8, 10, 11)
                ...
                .custom(assertElements(arrayContaining(2, 4, 6, 7, 8, 10, 11)));
    }

    @Test
    public void testTakeWhileIterator() {
        PrimitiveIterator.OfInt it =
                IntStream.of(2, 4, 5, 6).takeWhile(Functions.remainderInt(2)).iterator();
    ...
    public void testTakeWhileIterator2() {
        PrimitiveIterator.OfInt it =
                IntStream.of(1).takeWhile(Functions.remainderInt(2)).iterator();
        assertThat(it.hasNext(), is(false));
        assertThat(it.hasNext(), is(false));
    }
    ...
    public void testTakeWhileIterator3() {
        final PrimitiveIterator.OfInt it =
                IntStream.of(2).takeWhile(Functions.remainderInt(2)).iterator();
