...
public final class Students {
    ...
    public static final List<Student> ALL =
            Arrays.asList(
                    STEVE_CS_4,
                    MARIA_ECONOMICS_1,
                    VICTORIA_CS_3,
    ...
    public static final Function<Student, String> speciality =
    ...
    public static final Function<Student, Integer> course =
    ...
    public static final Function<Student, String> studentName =
            new Function<Student, String>() {
                @Override
                public String apply(Student student) {
