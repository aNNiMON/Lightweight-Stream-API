...
public class BiFunctionTest {
    ...
    public void testAndThen() {
        BiFunction<Character, Boolean, Integer> function =
                BiFunction.Util.andThen(toString, Functions.stringToInteger());
    ...
    private static final BiFunction<Character, Boolean, String> toString =
            new BiFunction<Character, Boolean, String>() {
                @Override
    ...
    private static final BiFunction<String, Boolean, String> changeCase =
