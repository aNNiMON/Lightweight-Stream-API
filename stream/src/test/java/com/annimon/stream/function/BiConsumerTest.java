...
public class BiConsumerTest {
    ...
    private static final BiConsumer<IntHolder, IntHolder> increment =
            new BiConsumer<IntHolder, IntHolder>() {
                @Override
    ...
    private static final BiConsumer<IntHolder, IntHolder> mulBy2 =
            new BiConsumer<IntHolder, IntHolder>() {
                @Override
                public void accept(IntHolder holder1, IntHolder holder2) {
                    holder1.value *= 2;
