...
public class DoubleConsumerTest {
    ...
    public void testAndThen() {
        ...
        DoubleConsumer consumer =
                DoubleConsumer.Util.andThen(new Multiplier(buffer, 0.1), new Multiplier(buffer, 2));

        consumer.accept(10d);
        assertThat(buffer, contains(closeTo(1, 0.0001), closeTo(20, 0.0001)));
        buffer.clear();

        consumer.accept(22);
        assertThat(buffer, contains(closeTo(2.2, 0.0001), closeTo(44d, 0.0001)));
        buffer.clear();
