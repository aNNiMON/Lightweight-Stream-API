...
public final class FindIndexed {
    ...
    public void testFindIndexed() {
        IntPair<Integer> result = Stream.rangeClosed(1, 10).findIndexed(sumEquals(7)).get();
    ...
    public void testFindIndexedWithStartAndStep() {
        IntPair<Integer> result =
                Stream.of(1, 11, 22, 12, 40).findIndexed(0, 10, sumEquals(42)).get();
    ...
    public void testFindIndexedNoMatch() {
        Optional<IntPair<Integer>> result = Stream.range(0, 10).findIndexed(sumEquals(42));
