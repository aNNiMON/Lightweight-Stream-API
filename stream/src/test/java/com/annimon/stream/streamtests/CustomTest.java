...
public final class CustomTest {
    ...
    public void testCustomIntermediateOperator_Reverse() {
        Stream.range(0, 10)
                ...
                .custom(assertElements(contains(9, 8, 7, 6, 5, 4, 3, 2, 1, 0)));
    }
    ...
    public void testCustomIntermediateOperator_SkipAndLimit() {
        Stream.range(0, 10)
                ...
                .custom(assertElements(contains(5, 6)));
    }
    ...
    public void testCustomIntermediateOperator_FlatMapAndCast() {
        ...
        Stream.of(lists)
                .custom(
                        new CustomOperators.FlatMap<List, Object>(
                                new Function<List, Stream<Object>>() {
