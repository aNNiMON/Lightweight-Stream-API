...
public final class MaxTest {
    ...
    @Test
    public void testMax() {
        Optional<Integer> max = Stream.of(6, 3, 9, 0, -7, 19).max(Functions.naturalOrder());
    ...
    public void testMaxDescendingOrder() {
        Optional<Integer> max =
                Stream.of(6, 3, 9, 0, -7, 19).max(Functions.descendingAbsoluteOrder());
    ...
    public void testMaxEmpty() {
        Optional<Integer> max = Stream.<Integer>empty().max(Functions.naturalOrder());
