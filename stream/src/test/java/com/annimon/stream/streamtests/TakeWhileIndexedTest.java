...
public final class TakeWhileIndexedTest {
    ...
    public void testTakeWhileIndexed() {
        Stream.of(1, 2, 3, 4, -5, -6, -7)
                ...
                .custom(assertElements(contains(1, 2)));
    }
    ...
    public void testIssue186OnIndexed() {
        AtomicInteger result =
                Stream.iterate(new AtomicInteger(0), UnaryOperator.Util.<AtomicInteger>identity())
                        .takeWhileIndexed(
                                new IndexedPredicate<AtomicInteger>() {
                                    @Override
    ...
    public void testTakeWhileIterator2() {
        Iterator<? extends Integer> it = Stream.of(1).takeWhileIndexed(sumRemainder(2)).iterator();
        assertThat(it.hasNext(), is(false));
        assertThat(it.hasNext(), is(false));
    }
    ...
    public void testTakeWhileIterator3() {
        final Iterator<? extends Integer> it =
                Stream.of(2).takeWhileIndexed(sumRemainder(2)).iterator();
