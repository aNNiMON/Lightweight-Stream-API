...
public final class SkipTest {
    ...
    public void testSkip() {
        Stream.range(0, 10).skip(7).custom(assertElements(contains(7, 8, 9)));
    }
    ...
    public void testSkipZero() {
        Stream.range(0, 2).skip(0).custom(assertElements(contains(0, 1)));
    }

    @Test
    public void testSkipMoreThanCount() {
        Stream.range(0, 10).skip(15).custom(StreamMatcher.<Integer>assertIsEmpty());
    }
    ...
    public void testSkipLazy() {
        ...
        stream.custom(assertElements(contains(3, 4, 5)));
    }
    ...
    public void testSkipAndLimit() {
        Stream.range(0, 10)
                .skip(2) // 23456789
                .limit(5) // 23456
                .custom(assertElements(contains(2, 3, 4, 5, 6)));
    }
    ...
    public void testSkipAndLimitMoreThanCount() {
        Stream.range(0, 10)
                .skip(8) // 89
                .limit(15) // 89
                .custom(assertElements(contains(8, 9)));
    }

    @Test
    public void testSkipMoreThanCountAndLimit() {
        Stream.range(0, 10).skip(15).limit(8).custom(StreamMatcher.<Integer>assertIsEmpty());
    }
    ...
    public void testSkipAndLimitTwice() {
        Stream.range(0, 10)
                ...
                .skip(2) // 456
                .limit(2) // 45
                .custom(assertElements(contains(4, 5)));
    }
}
