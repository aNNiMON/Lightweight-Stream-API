...
public final class ScanTest {
    ...
    public void testScan() {
        Stream.of(1, 2, 3).scan(Functions.addition()).custom(assertElements(contains(1, 3, 6)));
    }
    ...
    public void testScanNonAssociative() {
        Stream.of(1800, 2, 3, 5)
                ...
                .custom(assertElements(contains(1800, 1800 / 2, 1800 / 2 / 3, 1800 / 2 / 3 / 5)));
    }
    ...
    public void testScanWithIdentity() {
        Stream.of("a", "bb", "ccc", "dddd")
                ...
                .custom(assertElements(contains(0, 1, 3, 6, 10)));
    }

    @Test
    public void testScanWithIdentityOnEmptyStream() {
        Stream.<Integer>empty().scan(9, Functions.addition()).custom(assertElements(contains(9)));
    }
}
