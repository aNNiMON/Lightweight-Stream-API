...
public final class MapTest {
    ...
    public void testMapIntToSqrtString() {
        Function<Number, String> intToSqrtString =
        ...
        Stream.of(4, 9, 16, 64, 625)
                .map(intToSqrtString)
                .custom(assertElements(contains("[2]", "[3]", "[4]", "[8]", "[25]")));
    }

    @Test
    public void testMapStringToSquareInt() {
        final Function<String, Integer> stringToSquareInt =
        ...
        Stream.of("[2]", "[3]", "[4]", "[8]", "[25]")
                ...
                .custom(assertElements(contains(4, 9, 16, 64, 625)));
    }

    @Test
    public void testMapWithComposedFunction() {
        final Function<Integer, Integer> mapPlus1 =
