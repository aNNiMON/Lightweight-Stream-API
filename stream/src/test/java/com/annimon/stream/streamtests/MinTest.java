...
public final class MinTest {
    ...
    @Test
    public void testMin() {
        Optional<Integer> min = Stream.of(6, 3, 9, 0, -7, 19).min(Functions.naturalOrder());
    ...
    public void testMinDescendingOrder() {
        Optional<Integer> min =
                Stream.of(6, 3, 9, 0, -7, 19).min(Functions.descendingAbsoluteOrder());
    ...
    public void testMinEmpty() {
        Optional<Integer> min = Stream.<Integer>empty().min(Functions.naturalOrder());
